...
const Explore = ({ scrollToTop }: { scrollToTop: () => void }) => {
  ...
  return (
    <section className={`${brytzone}_home-explore`}>
      ...
      <div className="explore_text">
        ...
        <span className="scroll_top" onClick={scrollToTop}>
          <ScrollToTopButton />
        </span>
      </div>
    </section>
...
const ScrollToTopButton = () => {
  ...
  const handleScroll = () => {
    ...
    const scrollThreshold = 700; // Set your desired scroll distance here
