    ...
    <section className={`${brytzone}_home-how`}>
      ...
      <div className="hright">
        ...
        <motion.ul className="" variants={parentVariants} viewport={{ amount: 1, once: true }} onViewportLeave={() => setVisible(false)} onViewportEnter={() => setVisible(true)}>
          {visible && (
            <>
              {/* <motion.li className="" variants={liCheckVariants2} initial="hidden" animate="visible" custom={1}>
                ...
                <motion.span variants={li} initial="hidden" animate="visible" custom={1}>
                  Create an account with our sign up form
                </motion.span>
              </motion.li> */}
